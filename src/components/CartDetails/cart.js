...
const Cart = () => {
  ...
  const [cartTotal, setCartTotal] = useState(
    cartItems.reduce((amount, item) => item.total + amount, 0)
  );
      ...
      {cartItems.length !== 0 ? (
            ...
            <div className="cart-summary pt-3">
              ...
              <ul className="summary-table px-2">
                <li className="mb-4">
                  ...
                  <span className="fs-5">{cartTotal * 0.78}</span>
                </li>
                <li className="mb-4">
                  <span className="fs-5">
                    <b>IVA:</b>
                  </span>{" "}
                  <span className="fs-5">{cartTotal * 0.22}</span>
                </li>
                <hr />
                <li className="mb-4">
                  <span className="fs-5">
                  ...
                  <span className="fs-5">{cartTotal}</span>
                </li>
              </ul>
            </div>
            <div className="justify-content-between row mb-5">
              <button
                className="mt-5 col-6 col-sm-4 btnVaciar"
                onClick={() => initalState}
              >
                <a href="/"> Vaciar carrito</a>
              </button>
              <button className="mt-5 col-6 col-sm-5 btnSeguirComprando">
        ...
        <div className="row justify-content-center my-5">
          <ol className="list-group col-10 col-md-6">
            ...
            <button className="btn col-6 col-lg-4 mt-3 btnSeguirComprando">
              <NavLink className="fs-6" to={"/"}>
                Seguir comprando
              </NavLink>
            </button>
